class ArtifactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @artifact.save
        format.html { redirect_to tenant_project_url(tenant_id: Tenant.current_tenant.id, id: @artifact.project_id), notice: 'Artifact was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @artifact.update(artifact_params)
        format.html { redirect_to tenant_project_url(tenant_id: Tenant.current_tenant.id, id: @artifact.project_id), notice: 'Artifact was successfully updated.' }
